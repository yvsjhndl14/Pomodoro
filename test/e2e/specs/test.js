module.exports = {
  ...
  'wait for kitten test': (browser) => {
    ...
    // click on the start button and wait for 7s for kittent element to appear
    ...
    browser.expect.element('.well.kittens img').to.have.attribute('src').which.matches(/thecatapi/);
    browser.end()
  }
}
